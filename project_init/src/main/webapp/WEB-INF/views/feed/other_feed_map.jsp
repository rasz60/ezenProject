...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=b3f997f12f2b7a81b668be4e73a0fb98&libraries=services,clusterer,drawing"></script>
...
<%@ include file="../includes/header.jsp" %>
	<sec:authorize access="isAuthenticated()">
		...
		<div id="user_id" style="display:none">${user.userEmail}</div> <!-- 사용자의 Id값 가져오기, 필터에서 사용-->
	</sec:authorize>
...
<section class="container mb-5">
	...
	<div class="body-container">
		...
		<ul class="feed-tabs row mx-0 flex-nowrap">
			...
			<%-- 2- 맵 피드 버튼 --%>
			<li id="feed-map" class='nav-item active col-6' data-tab=''>
				<a href="/init/feed/otherUser?nick=${user.userNick }" class="nav-link">
					<i class="fa-solid fa-map-location-dot"></i>
				</a>
			</li>
		
			<%-- 3- 포스트 피드 버튼 --%>			
			<li id="feed-post" class='nav-item col-6' data-tab=''>
				<a href="/init/post/otherUser?nick=${user.userNick}" class="nav-link">
