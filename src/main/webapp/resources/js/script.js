...
fetch("products").then(function(response) {
	response.text().then(function(text) {
		document.getElementById("prod").innerHTML = text;
	});
});
*/
...
$(function() {
	let genderObj = document.getElementsByClassName("chck_gender");
	for ( var i = 0; i < genderObj.length; i++ ) {
		genderObj[i].addEventListener("click", function() {
	...
	let filterObj = document.getElementsByClassName("filter");
	for ( var i = 0; i < filterObj.length; i++ ) {
		filterObj[i].addEventListener("click", function() {
			var value = this.getAttribute("data-value");
			var url = new URL(window.location);
...
$(function setPage() {
	...
	switch(value1) {
		case "p_date" :
			$(".filter:nth-of-type(1)").css({"color":"black" , "font-weight":"700"});
			break;
		case "p_hit DESC" :
			$(".filter:nth-of-type(2)").css({"color":"black" , "font-weight":"700"});
			break;
		case "p_price" :
			$(".filter:nth-of-type(3)").css({"color":"black" , "font-weight":"700"});
			break;
		case "p_price DESC" :
			$(".filter:nth-of-type(4)").css({"color":"black" , "font-weight":"700"});
			break;
	}

	switch(value2) {
		case "'JORDAN'" :
			$(".brand_menu:nth-of-type(2)").css({"background-color":"black", "opacity":"0.7"});
			$(".brand_menu:nth-child(2)>a").css({"color":"white"});
			break;
		case "'NIKE'" :
			$(".brand_menu:nth-of-type(3)").css({"background-color":"black", "opacity":"0.7"});
			$(".brand_menu:nth-child(3)>a").css({"color":"white"});
			break;
		case "'ADIDAS'" :
			$(".brand_menu:nth-of-type(4)").css({"background-color":"black", "opacity":"0.7"});
			$(".brand_menu:nth-child(4)>a").css({"color":"white"});
			break;
		case "'NEW BALANCE'" :
			$(".brand_menu:nth-of-type(5)").css({"background-color":"black", "opacity":"0.7"});
			$(".brand_menu:nth-child(5)>a").css({"color":"white"});
			break;
		default :
			$(".brand_menu:nth-of-type(1)").css({"background-color":"black", "opacity":"0.7"});
			$(".brand_menu:nth-child(1)>a").css({"color":"white"});
			break;
	}
});